<template>
  <div class="max-w-4xl mx-auto">
    <!-- <div class="px-5">
        <div class="pt-10 md:pt-12 text-xl md:text-2xl text-gray-700 font-semibold mb-2">POSTS</div>
        <div class="text-gray-600 font-normal text-sm md:text-base">Select a topic</div>
    </div> -->
    ...
    <div class="px-5 pt-1">
      ...
      <nuxt-link :to="{ path: '/test' }" replace
        ><span class="tag-btn"
          >🧪<span class="text-gray-600 text-sm">테스트</span></span
        ></nuxt-link
      >
    </div>

    <div
      class="max-w-4xl grid grid-cols-1 md:grid-cols-1 mt-11 md:mt-12 mb-8 md:mb-12"
    >
      <div
      ...
      >
        <nuxt-link :to="`/blog/${article.slug}`">
          <div
            class="article-inner flex justify-between border-t py-6 border-gray-200"
          >
            <div class="w-full md:w-5/6">
              ...
              <h3
                class="mb-1 md:mb-1.5 text-lg md:text-xl font-semibold text-gray-700 transition group-hover:text-cherry group-hover:duration-500"
              >
                {{ article.title }}
              </h3>
              <p
