<template>
  <article class="relative max-w-4xl mx-auto justify-center mb-10 md:mb-10">
    ...
    >
      <!-- <span class="px-5 pt-10 text-base md:text-base text-gray-400 mb-2">{{
        article.category
      }}</span> -->
      ...
      <h1
        class="px-5 md:px-0 md:pt-10 mt-1 mb-5 text-2xl md:text-3xl text-center font-bold text-gray-700 keepall"
      >
        {{ article.title }}
      </h1>
    ...
    <div class="hidden lg:block w-full">
      <div>
        <nuxt-content
          :document="article"
          class="prose max-w-4xl keepall px-6 selection:bg-cherrylight"
        />
      </div>
    </div>
